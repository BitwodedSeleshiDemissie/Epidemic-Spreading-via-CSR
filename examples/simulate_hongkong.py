...
# Start infection at Hong Kong (IATA: HKG)
hongkong_id = airports[airports["IATA"] == "HKG"]["AirportID"].values[0]

# Run simulation for 5 steps
spread = epidemic_spread(A, id_to_index, hongkong_id, steps=5)
